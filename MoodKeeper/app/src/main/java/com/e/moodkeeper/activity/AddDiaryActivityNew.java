...
public class AddDiaryActivityNew extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d("AddDiaryActivityNew", String.valueOf(mood_id));
        Log.d("AddDiaryActivityNew", String.valueOf(weather_id));
        Log.d("AddDiaryActivityNew", days);
...
//                Snackbar.make(view, "Clicked" + item, Snackbar.LENGTH_LONG).show();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.cancel:
                Intent intent1 = new Intent(AddDiaryActivityNew.this, MainActivity.class);
                startActivityForResult(intent1, 1);
                break;
            case R.id.save:
                save();
                Intent intent2 = new Intent(AddDiaryActivityNew.this, MainActivity.class);
